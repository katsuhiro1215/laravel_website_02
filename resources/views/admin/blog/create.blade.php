        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">ブログ作成画面</h4> <br><br>
                            <form method="POST" id="myForm" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-8">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group">
                                                <input name="tags" value="home,tech" class="form-control" type="text" id="tags" data-role="tagsinput"> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                ...
                                <button type="submit" class="btn btn-info waves-effect waves-light"
                                    value="Insert Blog Category">保存する</button>
                            </form>
                        </div>
                    </div>
                </div>
